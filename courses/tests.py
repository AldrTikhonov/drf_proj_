...
class CourseLessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.course = Course.objects.create(name="Python Developer", description="Хороший курс", owner=self.user)
        self.lesson = Lesson.objects.create(title="Начало", course=self.course, owner=self.user)
    ...
    def test_course_update(self):
        ...
        self.assertEqual(
            data.get("description",), "Отличный курс"
        )
